const defaultData = {
	...
	educationInfo: [
		{
			schoolInput: "Syrinx school",
			degreeInput: "Spice Specialist",
			locationInput: "Xanadu, Alpha Centauri",
			startDateInput: "Jan 2102",
			endDateInput: "Dec 2106",
			skills: [
				...
				"Conducted groundbreaking research on optimizing spice yields in low-gravity conditions. This thesis was recognized for its innovative approach and potential applications in space-based agricultural systems, receiving the school's prestigious Academic Excellence Award in Spice Studies.",
				"Actively participated in the Syrinx school Spice Club, serving as Vice President in the final year. Co-organized the annual Interstellar Spice Symposium, facilitating knowledge exchange among students, faculty, and industry experts. Led a team of peers in a collaborative project with the school’s Botanical Research Center, developing a prototype for a sustainable, energy-efficient spice dehydrator.",
			],
			id: "a2b1",
		},
		{
			schoolInput: "Signals College",
			degreeInput: "Orbital Collection",
			locationInput: "Zanzibar, Alpha Centauri",
			startDateInput: "Jan 0111110",
			endDateInput: "Dec 1000000",
			skills: [
